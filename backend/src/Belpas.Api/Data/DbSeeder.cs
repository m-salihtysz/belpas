...
public static class DbSeeder
{
    public static void Seed(AppDbContext context)
    {
        ...
        context.Tesisler.AddRange(
            ...
            new Tesis { 
                Ad = "Ormanpark", Slug = "ormanpark", Kategori = "Restoran & Kafe", 
                Aciklama = "2006 yılında “Şehrin içinde orman keyfi” sloganıyla, Ormanpark’ı Sakarya halkının hizmetine sunduk. Dünya mutfağından yerel lezzetlere kadar geniş bir yelpazede sunulan zengin menü çeşitlerimizle, farklı damak zevklerine hitap etmeyi amaçlıyoruz.\n\nOrmanpark, siz değerli misafirlerimize üstün hizmet kalitesi ve cazip fiyatlarla, memnuniyet odaklı bir deneyim sunmaktadır. Şehir merkezinde, doğal bir ortam yaratmak amacıyla tasarlanan mekanımız, yüzyıllık dişbudak ağaçlarının gölgesinde, 18 dönümlük arazi üzerine kurulu olup, 3.250 m² kullanım alanı sunmaktadır. Kent yaşamının stresinden uzaklaşmak isteyen herkese, huzurlu bir kaçış noktası sağlamaktadır. Ormanpark, Türkiye’de ilk defa uygulanan yerden yükseltmeli ahşap yapılar ile inşa edilmiştir. Mekanımızda Restoran, Dört Mevsim Kafeterya, Sade Bahçe Kafeterya, çocuk parkı ve otopark gibi çeşitli alanlar bulunmaktadır.\n\nBugün Ormanpark, Sakarya’da hizmet sektöründe öncü kuruluşlardan biri haline gelmiştir ve misafirlerine doğal bir ortamda, kaliteli hizmet sunmaya devam etmektedir.", 
                HaftaIciSaat = "09:00–23:00", HaftaSonuSaat = "09:00–23:00", Telefon = "0264 291 08 78",
                Harf = "O", LogoUrl = "/images/logolar/ormanpark.png", ResimUrl = "/images/tesisler/ormanpark.jpg", MenuPdfUrl = "/documents/ormanpark-menu.pdf", MenuGorselUrl = "/images/menuler/ormanpark-menu.png" 
            },
            new Tesis { 
                Ad = "Ormanpark - Dört Mevsim", Slug = "ormanpark-dort-mevsim", Kategori = "Restoran & Kafe", 
                Aciklama = "Sakarya Büyükşehir Belediyesi’ne bağlı Ormanpark Sosyal Tesisleri içerisinde konumlanan 4 Mevsim Kafeterya, doğa ile bütünleşen konseptiyle ziyaretçilerine farklı bir deneyim sunar. Orman esintileriyle şekillenen bu özel mekân, günün her saatinde sakin ve ferah bir ortam arayanlar için cazip bir durak niteliğindedir. Menüsünde yer alan pratik atıştırmalıklar ve çeşitli içecek seçenekleriyle, kısa molalarınızı keyifli anlara dönüştürmeyi amaçlar. Yeşillikler arasında konumlanan yapısı sayesinde, hem dinlenmek hem de sosyal vakit geçirmek isteyen misafirler için ideal bir buluşma alanı oluşturur. Her mevsimde ziyaret edilebilen 4 Mevsim Kafeterya, doğanın içinde huzurlu bir atmosferde vakit geçirmek isteyen herkese hitap eden sıcak ve davetkâr bir sosyal noktadır.", 
                HaftaIciSaat = "09:00–23:00", HaftaSonuSaat = "09:00–23:00", Telefon = "0264 291 08 78",
                Harf = "O", LogoUrl = "/images/logolar/ormanpark-dort-mevsim.png", ResimUrl = "/images/tesisler/ormanpark-dort-mevsim.jpg", MenuPdfUrl = "/documents/ormanpark-dort-mevsim-menu.pdf", MenuGorselUrl = "/images/menuler/ormanpark-dort-mevsim-menu.png" 
            },
            new Tesis { 
                Ad = "Ormanpark - Sade Kahve", Slug = "ormanpark-sade-kahve", Kategori = "Restoran & Kafe", 
                Aciklama = "Sade Kahve, Sakarya Büyükşehir Belediyesi’ne bağlı Ormanpark Sosyal Tesisleri içerisinde konumlanan, doğadan ilham alan konseptiyle öne çıkan bir kafeteryadır. Orman temasıyla şekillenen mekân, sade ve huzurlu atmosferiyle ziyaretçilerine şehirden uzak, dinlendirici bir ortam sunar.\n\nMenüsünde yer alan sade kahve çeşitlerinin yanı sıra sıcak ve soğuk içecek alternatifleriyle misafirlerine keyifli bir mola imkânı sağlar. Özellikle gençlerin tercih ettiği bu alan, arkadaş buluşmaları ve sosyal vakit geçirmek için ideal bir ortam oluşturmaktadır.\n\nDoğayla iç içe konumu ve samimi atmosferiyle Sade Kahve, Ormanpark içerisinde keyifli anların yaşandığı özel bir buluşma noktasıdır.", 
                HaftaIciSaat = "09:00–23:00", HaftaSonuSaat = "09:00–23:00", Telefon = "0264 291 08 78",
                Harf = "O", LogoUrl = "/images/logolar/ormanpark-sade-kahve.png", ResimUrl = "/images/tesisler/ormanpark-sade-kahve.jpg", MenuPdfUrl = "/documents/ormanpark-sade-kahve-menu.pdf", MenuGorselUrl = "/images/menuler/ormanpark-sade-kahve-menu.png" 
            },
            new Tesis { 
                Ad = "Çark-ı Dem (Aziz Durak Parkı)", Slug = "cark-i-dem", Kategori = "Restoran & Kafe", 
                Aciklama = "Kent merkezinin tam içinde yer alan Aziz Duran Parkı (Kentpark), 160.000 m² alandaki enkazın yeşil alana dönüştürülmesiyle halkımıza sunulmuştur. Eski Zirai Donatım Fabrikası arazisine inşa edilen park, şehrin yorucu yaşamından arınmak isteyen vatandaşlarımız için huzurlu bir dinlenme alanı haline gelmiştir. Aziz Duran Parkı (Kentpark), yaklaşık 5 km uzunluğunda yürüyüş ve koşu yollarına sahip olup, doğal ortamı ve ağaçları koruyarak tüm yüzeyi çimlendirilmiştir. Parkta bulunan 14.000 m² büyüklüğündeki gölette deniz bisikleti ile gezinti yapmak mümkündür. Ayrıca, Kentpark’ta hizmet veren 1 Büfe, 1 Self Büfe ve 1 Restaurant-Cafe de, ziyaretçilerine en uygun fiyatlarla kaliteli hizmet sunmaya devam etmektedir.", 
                HaftaIciSaat = "09:00–23:00", HaftaSonuSaat = "09:00–23:00", Telefon = "0264 273 19 81",
                Harf = "Ç", LogoUrl = "/images/logolar/cark-i-dem.png", ResimUrl = "/images/tesisler/cark-i-dem.jpg", MenuPdfUrl = "/documents/cark-i-dem-menu.pdf", MenuGorselUrl = "/images/menuler/cark-i-dem-menu.png" 
            },
