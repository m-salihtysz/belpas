...
export class EventService {
  ...
  private mockEtkinlikler: Etkinlik[] = [
    ...
    },
    {
      ...
      detay: 'Ormanpark birimlerimizin eşsiz doğasında temiz hava eşliğinde yürüyüşümüz saat 09:00 da başlayacak, ardından tesis bahçemizde kahvaltı ikramı sunulacaktır.',
    ...
    },
    {
      ...
      kategori: 'Çocuk & Aile',
      ozet: 'Mavi bayraklı Kocaali sahil birimlerimizde çocuklar için patlamış mısır eşliğinde açık hava sineması.',
